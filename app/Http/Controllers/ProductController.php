...
//
//            if($request->input('_sort') && $request->input('_sort')!='category.name'){
//                $sortField = $request->input('_sort', 'id');
//            } else $sortField = 'id';
//
//            //$sortField = $request->input('_sort', 'id'); //Error when '_sort' === 'category.name'
//
//            $sortOrder = $request->input('_order', 'ASC');
//
//            $query = Product::with('category')->orderBy($sortField, $sortOrder);
//
