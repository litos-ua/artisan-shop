...
//         >
//             {(formik) => (
//                 <form onSubmit={formik.handleSubmit} className="customer-data-form" >
//                     <Box className="input-group" sx={{ display: 'flex', flexDirection: 'row'  }}>
//                         <TextField
//                             label="First Name"
//                             fullWidth={true}
...
//                             sx={{ padding: '1vh', marginRight:'2vw' }}
//                         />
//                     </Box>
